...
<div class="row">
  ...
  <div class="col-md-4 stretch-card grid-margin">
    <div class="card bg-gradient-warning card-img-holder text-white">
      <div class="card-body">
        <img src="{{ asset('assets/images/dashboard/circle.svg') }}" class="card-img-absolute" alt="circle-image" />
        <h4 class="font-weight-normal mb-3">Total Barang <i class="mdi mdi-tag-multiple mdi-24px float-right"></i>
        </h4>
        <h2 class="mb-5">{{ $barang }}</h2>
        <h6 class="card-text">Barang untuk label TnJ</h6>
      </div>
    </div>
  </div>
</div>
